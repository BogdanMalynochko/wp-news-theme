        ...
        <div class="news">
            ...
            <div class="news-wrapper">
                ...
                while ($homeNews -> have_posts()) {
                    ...
                    <?php if ($link) { ?>
                        <a href="<?php echo esc_url( $link['url'] ); ?>" class="item">
                            <?php if ($image) { ?>
                                <?php echo wp_get_attachment_image($image, 'full', "", ["class" => "width"]); ?> 
                            <?php } ?>
